...
def fetch_source_text_excerpt(source_url: str, max_chars: int = SOURCE_TEXT_MAX_CHARS) -> str:
    """
    Downloads the source URL HTML, strips tags/scripts/styles, returns a clean text excerpt.
    This is what we pass to the model as page_text to preserve factual details.
    """
